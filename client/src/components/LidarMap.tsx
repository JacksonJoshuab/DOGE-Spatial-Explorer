...
// 905 N Columbus St, West Liberty IA 52776 — Parcel 0112177049
const WEST_LIBERTY_IA = { lat: 41.57688, lng: -91.26073 }; // 905 N Columbus St, West Liberty IA 52776
    ...
    <div className="p-4 space-y-4">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Property Map — West Liberty, IA</h3>
        </div>
      ...
      {mapMode === "lidar" ? (
        <div className="relative rounded-xl overflow-hidden" style={{ height: 220 }}>
          <img 
            ...
            alt="LiDAR Map — 905 Backyard, West Liberty, IA · 10/8/2025"
          ...
          <div className="absolute bottom-2 right-2 glass rounded px-1.5 py-0.5">
            <span className="text-[9px] telemetry">20.7m × 78.9m · SCAN 10/8/2025</span>
          </div>
        </div>
      ) : (
      ...
      <div className="glass rounded-xl p-3 flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-xs text-white font-medium">West Liberty, Iowa 52776</p>
          <p className="text-[9px] telemetry text-cyan-400">41.5769°N, 91.2607°W · Zone 5b · Parcel 0112177049</p>
        </div>
      </div>
    </div>
  );
