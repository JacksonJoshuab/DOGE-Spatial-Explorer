 ...
 * Data: Open-Meteo API (free, no key) — Wilton, Iowa 52776
...
export default function WeatherPanel() {
  ...
  const handleRefresh = () => {
    refresh();
    toast.info("🌤️ Refreshing Wilton, IA weather...", { duration: 2000 });
  };
    ...
    <div className="p-4 space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Wilton, IA — Live Weather</h3>
          {loading && (
      ...
      <div className="glass-gold rounded-xl p-3">
        ...
        <p className="text-[10px] text-white/30 mt-1">— Chip McHaymaker, Wilton Iowa Groundskeeper</p>
      </div>

      <p className="text-[9px] text-white/20 text-center">
        Live data via Open-Meteo.com · Wilton, IA (41.59°N, 91.02°W) · Updates every 15 min
      </p>
    </div>
  );
}
