...
const CHIP_QUIPS = [
  ...
  { title: "🦅 Chip's Patriotic Moment", body: "Beautiful day in Wilton, Iowa! Stars and stripes flying, lawn getting treated, Jetson Orin humming along. This is the American dream, folks." },
