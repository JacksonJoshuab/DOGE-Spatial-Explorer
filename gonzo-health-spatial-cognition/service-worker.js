const CACHE = "gsc-spatial-cognition-brand-v3";
const CORE = [
  "./", "./index.html", "./boot.mjs", "./brand-refresh.mjs", "./brand-refresh.css",
  "./manifest.webmanifest", "./brand-icon.svg", "./icon.svg", "./brand-hero.svg",
  "./generation-media.svg", "./offline.html", "./privacy.html", "./support.html",
...
self.addEventListener("install", (event) => {
  event.waitUntil(
    caches.open(CACHE)
      .then((cache) => cache.addAll([...CORE, ...PAYLOAD]))
