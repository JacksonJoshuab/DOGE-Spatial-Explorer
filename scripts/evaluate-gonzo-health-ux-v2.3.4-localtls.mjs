...
const runtimeURL = new URL('./.evaluate-gonzo-health-ux-v2.3.4-localtls.runtime.mjs', import.meta.url);
...
source = source.replace(expected, "const EXPERIENCE='gonzo-health-experience/2.3.4';");
